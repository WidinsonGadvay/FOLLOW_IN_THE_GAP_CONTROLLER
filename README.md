...
### 3.Parámetros  importantes y sus valores :
Mediante esta tabla se presenta a continuaciòn los paramtros que se usan para este controlador considerando que su  velocidad màxima alcanzada es de  10 m/s.
...
### 4.Configuraciòn para la simulacion y lanzamiento de los nodos:
...
**7.Método utilitario: formateo de tiempo:**
...
**8.Callback principal: odom_callback:**
...
**10.Cálculo de distancia y zona de inicio:**
